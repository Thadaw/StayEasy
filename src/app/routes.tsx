...
const BookingPage = lazy(() => import('../features/booking/pages/GuestBookingDetailsPage'))
const BookingViewPage = lazy(() => import('../features/booking/pages/BookingSummaryPage'))
