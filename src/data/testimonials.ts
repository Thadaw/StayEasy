...
export const testimonials: Testimonial[] = [
  { id: 1, name: "Jenny Wilson", role: "Travel enthusiast", avatar: "", quote: "ServeIQ made our trip so simple! The booking process was quick, easy, and stress-free." },
  ...
  { id: 4, name: "Sarah Chen", role: "Adventure seeker", avatar: "", quote: "Found the perfect hidden gem thanks to ServeIQ. Will definitely book again!" },
