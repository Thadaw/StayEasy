          ...
          <div className="md:pt-0">
            ...
            {hasSelection ? (
              <div>
                ...
                <button
                  onClick={onReserve}
                  disabled={!hasSelection || !!capacityError || (!!user && (!checkIn || !checkOut)) || isCreating}
                  className="w-full mt-4 py-3.5 rounded-xl text-white font-semibold text-sm transition-all hover:shadow-lg hover:shadow-brand-accent/30 disabled:opacity-40 disabled:cursor-not-allowed bg-brand-accent hover:bg-brand-accent-hover flex items-center justify-center gap-2"
                >
                  {isCreating ? (
                    <>
