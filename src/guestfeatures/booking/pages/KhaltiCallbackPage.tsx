  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F8FAFC] font-jakarta">
      <div className="text-center">
        <div className="animate-spin w-8 h-8 border-4 border-[#1A3C5E] border-t-transparent rounded-full mx-auto mb-4" />
        <p className="text-sm text-gray-500">Processing Khalti payment...</p>
      </div>
    </div>
  )
}
